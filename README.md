...
This project is a party of `Monsters` microservice, which handles maps's related requests. It is written ESM. Keep this in mind while working on this project. For some reason, people do not know what esm is.
...
This project utilizes winston for logging, using package `simpl-loggar`. Its an extremely basic logger
...
- 1-99 - Generic errors
- 400 - 499 - Errors specific to this service
